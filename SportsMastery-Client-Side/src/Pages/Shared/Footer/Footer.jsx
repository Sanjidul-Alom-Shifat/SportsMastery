...
const Footer = () => {
    return (
        <footer className="bg-gradient-to-r from-teal-100 via-teal-100 to-teal-100 mt-10 lg:mt-12">
            <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <img src={logo} className="mr-5 h-6 w-6 rounded-full sm:h-9 sm:w-9" alt="logo" />
                        <p className="max-w-xs mt-4 text-sm text-black">
                        Unleash your passion and master your craft with SportsMastery, the premier learning school for aspiring athletes.
                        </p>
