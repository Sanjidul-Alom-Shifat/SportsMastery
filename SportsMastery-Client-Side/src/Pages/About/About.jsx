...
const About = () => {
    return (
        ...
        <div className="container mt-12 mx-auto md:px-6">
            ...
            <Helmet>
                <title>SportsMastery | About Page</title>
            </Helmet>

            <section className="mb-32 text-center">
            <h1 className="text-xl mt-5 mb-7 lg:mb-9 font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white"><span className="text-teal-500">Spectator&#39;s</span> Reviews </h1>

                <div className="grid gap-x-6 mx-3 md:grid-cols-3 xl:gap-x-12">
